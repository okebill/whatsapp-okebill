...
-- Multi-Tenant SaaS Platform (MySQL Compatible)
-- ===================================
...
ALTER TABLE message_stats ADD COLUMN connection_id VARCHAR(50);
ALTER TABLE message_stats ADD COLUMN target_type ENUM('individual', 'group') DEFAULT 'individual';
