-- VPS Compatible Database Schema
-- Compatible with MySQL 5.7+ and MariaDB 10.2+

-- Buat database jika belum ada
CREATE DATABASE IF NOT EXISTS wabot_api CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE wabot_api;
...
-- Note: IF NOT EXISTS tidak didukung di MySQL 5.7, jadi kita skip atau gunakan ALTER TABLE terpisah
