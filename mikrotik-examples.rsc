...
# ================================================================
# 1. Script untuk notifikasi PPPoE user connect
# ================================================================
:local nama "$user";
...
/tool fetch url="$baseUrl/send-message?api_key=$apiKey&number=$adminNumber&message=$message" keep-result=no;
...
# ================================================================
# 7. Script untuk kirim pesan ke group
# ================================================================
:local message "Test%20message%20ke%20group%20dari%20Mikrotik";
/tool fetch url="$baseUrl/send-group-message?api_key=$apiKey&groupId=$groupId&message=$message" keep-result=no;
...
# ================================================================
# Cara penggunaan:
# 1. Ganti "your-domain.com" dengan domain/IP server Anda
# 2. Ganti nomor admin dengan nomor WhatsApp Anda
# 3. Ganti group ID dengan ID grup yang valid
# 4. Copy script yang dibutuhkan ke System > Scripts
# 5. Jalankan script manual atau dengan scheduler
# ================================================================ 